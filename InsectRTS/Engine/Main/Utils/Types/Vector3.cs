...
namespace Engine
{
    ...
    public struct Vector3 : IEquatable<Vector3>
    {
        ...
        /// <summary>
        /// Cast the vector to a <see cref="OpenTK.Vector3"/>.
        /// </summary>
        /// <param name="vector">The vector to cast.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator OpenTK.Vector3(Vector3 vector)
        {
            return Unsafe.ReinterpretCast<Vector3, OpenTK.Vector3>(vector);
        }
    }
}
